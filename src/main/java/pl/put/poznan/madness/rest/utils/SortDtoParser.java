 ...
 *
 * This class provides a static method for parsing a {@link SortDto} object and
 * returning a {@link SortDtoParser}
 * object that contains the parsed data and any error messages that may have
 * occurred during parsing.
 *
 * The parsed data can be retrieved using the {@link #getParsedData()} method,
 * and the error message (if any) can be
 * retrieved using the {@link #getMessage()} method. The {@link #isValid()}
...
public class SortDtoParser {
  ...
  /**
   * A string containing an error message if an error occurred during parsing, or
  ...
  /**
   * Constructs a new {@link SortDtoParser} object with the given {@link SortDto}
   * object.
   * If validating fails the {@link SortDtoParser#errorMessage} will be populated
  ...
  /**
   * Returns a new {@link SortDtoParser} object with the given {@link SortDto}
   * object.
   *
   * @param dto the {@link SortDto} object to be parsed
   * @return {@link SortDtoParser} object with validation result of given
   *         {@link SortDto} object
   */
  ...
  /**
   * Setups the {@link SortDtoParser} object by parsing object's
   * {@link SortDtoParser#sortDto}. Validates that the
   * data is:
   * <ul>
   * <li>all of same sortable type,</li>
   * <li>either a Number, a String or an object with sortable property,</li>
   * <li>if the data is made up of objects then all of them need to have a desired
   * key.</li>
   * </ul>
   *
   ...
   * @return type of keys
   * @throws InvalidSortInputException if given keys aren't all comparable with
   *                                   each other
   */
