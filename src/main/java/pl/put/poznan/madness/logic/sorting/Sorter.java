...
/**
 * Utility class that provides a method for sorting an array using a given {@link SortingStrategy}
 * implementation.
 *
 * <p>This class allows sorting an array by simply providing the desired sorting strategy, without
 * having to worry about the details of the sorting algorithm itself.
 */
public class Sorter {
   ...
   *
   * @param sortingStrategy the {@link SortingStrategy} implementation to be used by this {@link
   *     Sorter} object
   */
  ...
  /**
   * Sorts the given array using the {@link SortingStrategy} implementation provided in the
   * constructor.
   *
